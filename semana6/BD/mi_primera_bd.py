...
conn.execute(
    """
    INSERT INTO PLATOS (id, nombre, precio, categoria) 
    VALUES (1, "Pizza", 10.99, "italiana")
    VALUES (2, "Hamburguesa", 8.99, "Americana")
    VALUES (3, "Sushi", 12.99, "Japonesa")
    VALUES (4, "Ensalada", 6.99, "Vegetariana")
    """
)
...
try:
    ...
    print("La tabla MATRICULAS INNER JOIN  ya existe")
